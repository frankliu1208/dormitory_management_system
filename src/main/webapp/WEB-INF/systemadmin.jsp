...
<html>
<head>
<%--  this is the main page after system administrator log-in successfully  --%>
    <meta charset="utf-8" />
...
<%--  define the change method, used in below      --%>
        function change(url,index){
            // start from L55,  remove all the class of a tags below,  add class = "active" according to the defined index
            $(".list-group-item").removeClass("active");
            $(".list-group-item").eq(index).addClass("active");
            // attr used to get or set self-defined property, below re-set the value of src in the iframe tag, L97
            $("iframe").attr("src","/"+url);
        }
    </script>
</head>
...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        <ul class="nav navbar-nav navbar-left">
            <li>
                <a style="font-size: 26px;">Dormitory management system-system administrator</a>
            </li>
        </ul>
        <span style="color: #CCCCCC;font-size: 26px;position: relative;top: 5px;"></span>
        <ul class="nav navbar-nav navbar-right">
            <%-- the data comes from AccountController, L45       --%>
            <li>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-2">
        <%-- difference :  href="#" and href="javascript:void(0)"
          # includes a position info，go to the top of this web page
         while javascript:void(0), means it is a dead link    --%>
