...
<%--   the backend controller will get the values of "key" and "value"  , which is value in option tage(either "number" or "name")
     and user input                 --%>
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" name="dormitoryId">
            <%--     come from studentcontroller,  L32  起别名为dormitory, 动态生成option     --%>
                                                    <c:forEach items="${dormitoryList}" var="dormitory">
...
<script>
    $('#updateUserModal').on('show.bs.modal', function(event) {
        // get the data from the button,  check L84, the data from the list is attached to the button.
        ...
        // jQuery, find the related tags, assign the value getting from the button to it
        ...
        // updating the data:  select gender according to the list
